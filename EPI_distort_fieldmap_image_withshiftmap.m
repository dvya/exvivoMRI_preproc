function [data_out, deform_transform, i, j, s, m, n] = EPI_distort_fieldmap_image_withshiftmap(data, distort_dim,...
                                                                                   deform_scale_factor, shift, data_mask, mask_distorted)
...
%    substantially. 
% Authors: Chitresh Bhushan, Divya Varadarajan
