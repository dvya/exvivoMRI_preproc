...
dwell=$( echo "scale=10; $dwelltime / 10^9" | bc -l)
...
matlab -nosplash -nodesktop -r "addpath('./flashFieldmapScripts'); preprocess1; exit"
# matlab script
# inputs:
...
if [ "${GradNonLin}" = "yes" ] ; then 
    ...
    matlab -nosplash -nodesktop -r "addpath('./flashFieldmapScripts'); preprocess2; exit"
...
if [ "${GradNonLin}" = "yes" ] ; then 
    ...
    matlab -nosplash -nodesktop -r "addpath('./flashFieldmapScripts'); preprocess3; exit"
    ...
    matlab -nosplash -nodesktop -r "addpath('./flashFieldmapScripts'); preprocess3_noGradNonLin; exit"
    # convert grad nonlinearity and B0 corr real/imag output to abs/pha
