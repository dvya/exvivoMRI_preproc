...
nii_real = load_nifti('fmap2D__unwarp_grad__unwarp_B0__real.nii.gz');
nii_imag = load_nifti('fmap2D__unwarp_grad__unwarp_B0__imag.nii.gz');
...
save_nifti(nii_mag, 'fmap2D__unwarp_grad__unwarp_B0__mag.nii.gz');
save_nifti(nii_pha, 'fmap2D__unwarp_grad__unwarp_B0__pha.nii.gz');
